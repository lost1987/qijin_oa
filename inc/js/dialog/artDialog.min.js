...
(function(e, t) {
    ...
    return e.$ === t && (e.$ = n),
        n.fn = n.prototype = {
            constructor: function(e, t) {
                ...
                if (typeof e == "string") {
                    n = r.exec(e);
                    if (n && n[2]) return i = t.getElementById(n[2]),
            ...
            hasClass: function(e) {
                var t = " " + e + " ";
                return (" " + this[0].className + " ").replace(i, " ").indexOf(t) > -1 ? !0: !1
            },
            addClass: function(e) {
        ...
        n.fn.find = function(e) {
            var t,
                r = this[0],
                i = e.split(".")[1];
            return i ? document.getElementsByClassName ? t = r.getElementsByClassName(i) : t = s(i, r) : t = r.getElementsByTagName(e),
                n(t[0])
        },
        n.each = function(e, n) {
            var r,
        ...
        n.data = function(e, r, i) {
            var s = n.cache,
                u = o(e);
            return r === t ? s[u] : (s[u] || (s[u] = {}), i !== t && (s[u][r] = i), s[u][r])
        },
    ...
    function(e, t, n) {
        ...
        var r,
            ...
            l = function(e, t, s) {
                e = e || {};
                if (typeof e == "string" || e.nodeType === 1) e = {
                    content: e,
                    fixed: !a
                };
                var u,
                    c = l.defaults,
                    h = e.follow = this.nodeType === 1 && this || e.follow;
                for (var p in c) e[p] === n && (e[p] = c[p]);
                e.id = h && h[o + "follow"] || e.id || o + i,
                    u = l.list[e.id];
                if (u) return h && u.follow(h),
                    u.zIndex().focus(),
                    u;
                f || (e.fixed = !1);
                ...
                return t !== n && (e.ok = t),
                    ...
                    i++,
                    l.list[e.id] = r ? r.constructor(e) : new l.fn.constructor(e)
            };
        l.version = "5.0.2",
            l.fn = l.prototype = {
                ...
                content: function(t) {
                    ...
                    return this._elemBack && (this._elemBack(), delete this._elemBack),
                        typeof t == "string" ? u.html(t) : t && t.nodeType === 1 && (s = t.style.display, n = t.previousSibling, r = t.nextSibling, i = t.parentNode, this._elemBack = function() {
                            n && n.parentNode ? n.parentNode.insertBefore(t, n.nextSibling) : r && r.parentNode ? r.parentNode.insertBefore(t, r) : i && i.appendChild(t),
                                t.style.display = s,
                                o._elemBack = null
                        },
                            u.html(""), a.appendChild(t), e(t).show()),
                        this._reset(),
                        this
                },
                title: function(e) {
                    var t = this.dom,
                        ...
                        r = t.title,
                        i = "d-state-noTitle";
                    return e === !1 ? (r.hide().html(""), n.addClass(i)) : (r.show().html(e), n.removeClass(i)),
                        this
                },
                position: function() {
                    var e = this.dom,
                        ...
                        p = (f - c) * 382 / 1e3 + u,
                        d = t.style;
                    return d.left = Math.max(parseInt(h), s) + "px",
                        d.top = Math.max(parseInt(p), u) + "px",
                        this._follow && (this._follow.removeAttribute(o + "follow"), this._follow = null),
                        this
                },
                size: function(e, t) {
                    var n = this.dom.main[0].style;
                    return typeof e == "number" && (e += "px"),
                ...
                follow: function(t) {
                    ...
                    var i = r.fixed,
                        ...
                        N = i ? 0: h,
                        C = i ? 0: p;
                    return x = x < N ? g: x + E > l && g - E > N ? g - E + v: x,
                ...
                button: function() {
                    var t = this.dom,
                        ...
                        h,
                        p;
                    for (; a < u.length; a++) f = u[a],
                        l = f.value,
                        c = f.id || l,
                        h = !s[c],
                        p = h ? document.createElement("input") : s[c].elem,
                        p.type = "button",
                        p.className = "d-button",
                        s[c] || (s[c] = {}),
                        l && (p.value = l),
                        f.width && (p.style.width = f.width),
                        f.callback && (s[c].callback = f.callback),
                        f.focus && (this._focus && this._focus.removeClass(i), this._focus = e(p).addClass(i), this.focus()),
                        p[o + "callback"] = c,
                        p.disabled = !!f.disabled,
                        h && (s[c].elem = p, r.appendChild(p));
                    return n[0].style.display = u.length ? "": "none",
                        this
                },
                visible: function() {
                ...
                close: function() {
                    ...
                    l.focus === this && (l.focus = null),
                        this._follow && this._follow.removeAttribute(o + "follow"),
                    ...
                    if (r) t.remove();
                        ...
                        for (var s in this) this.hasOwnProperty(s) && s !== "dom" && delete this[s];
                        this.hidden()
                    }
                ...
                showborder:function(e){
                    if(e.showborder === false){
                        $(".d-outer").css('border',0);
                        $(".d-inner").css('border',0);
                    }else{
                        $(".d-outer").css('border','1px solid rgba(0, 0, 0, .7)');
                    }
                },
                _getDom: function() {
                    var n = document.body;
                    if (!n) throw new Error('artDialog: "documents.body" not ready');
                    var r = document.createElement("div");
                    r.style.cssText = "position:absolute;left:0;top:0",
                        r.innerHTML = l._templates,
                        n.insertBefore(r, n.firstChild);
                    var i,
                        s = 0,
                        o = {},
                        u = r.getElementsByTagName("*"),
                        a = u.length;
                    for (; s < a; s++) i = u[s].className.split("d-")[1],
                        i && (o[i] = e(u[s]));
                    return o.window = e(t),
                ...
                _addEvent: function() {
                    ...
                    t.wrap.bind("click",
                        function(n) {
                            ...
                            if (r === t.close[0]) return e._click("cancel"),
                                !1;
                            i = r[o + "callback"],
                                i && e._click(i)
                        }).bind("mousedown",
            ...
            l.fn.constructor.prototype = l.fn,
            ...
            l._templates = '<div class="d-outer"><table class="d-border"><tbody><tr><td class="d-nw"></td><td class="d-n"></td><td class="d-ne"></td></tr><tr><td class="d-w"></td><td class="d-c"><div class="d-inner"><table class="d-dialog"><tbody><tr><td class="d-header"><div class="d-titleBar"><div class="d-title"></div><a class="d-close" href="javascript:/*artDialog*/;">\u00d7</a></div></td></tr><tr><td class="d-main"><div class="d-content"></div></td></tr><tr><td class="d-footer"><div class="d-buttons"></div></td></tr></tbody></table></div></td><td class="d-e"></td></tr><tr><td class="d-sw"></td><td class="d-s"></td><td class="d-se"></td></tr></tbody></table></div>',
            l.defaults = {
            ...
            this.artDialog = e.dialog = e.artDialog = l
